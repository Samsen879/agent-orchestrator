					...
					sessions: [
						{
							...
							isTerminated: false,
							humanGateId: "gate-1",
							humanGateReason: "product_decision",
							humanGateRequiredDecision: "Choose A or B",
							humanGateAffectedTaskId: "task-a",
							humanGateAllowedActions: ["choose-a", "choose-b"],
							humanGateDetectedAt: "2026-06-10T15:00:00Z",
							humanGateAgeSeconds: 4504,
							humanGateDependencyImpact: 2,
